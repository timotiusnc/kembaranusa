...
export function Hero() {
  return (
    <Container className="pb-16 pt-8 text-center lg:pt-20">
      <Image
        src={knLogo}
        alt="Kembara Nusa logo"
      ...
      <h1 className="mx-auto mt-4 max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        <div className="text-3xl">Bakti Sosial + Explore</div>
        <span className="relative whitespace-nowrap text-red-500">
          ...
          <span className="relative">Lombok</span>
        </span>
      </h1>
      <p className="mx-auto mt-6 max-w-3xl text-lg tracking-tight text-slate-700">
        <strong>16-20 Juli 2025</strong> <br />
        Bakti Sosial Pengobatan dan Penyuluhan Kesehatan Gigi dan Mulut (SKP
        Kemenkes)
        <br />+ Explore Lombok
      </p>
      <div className="mt-10 flex justify-center gap-x-6">
        <Button href="/register">Daftar Sekarang</Button>
        <Button href="/projects/lombok-2025" variant="outline">
          <svg
            aria-hidden="true"
          ...
          <span className="ml-3">Lebih Lanjut</span>
        </Button>
      </div>
    </Container>
  )
